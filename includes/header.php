  ...
  <div class="nav-container">
    ...
    <div class="nav-right">
      ...
      <div class="nav-actions">
        <a href="cart.php" class="nav-cart" data-count="<?php echo $cart_count ?? 0; ?>" title="Cart">🛒</a>
        <a href="contact.php" class="nav-help" title="Help"><i class="fa fa-comments"></i> Help</a>
      </div>
    </div>
  </div>

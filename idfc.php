...
<head>
    ...
    <title>IDFC FASTag - Vehicle Categories | Apna Payment Services</title>
...
<?php include __DIR__ . '/includes/header.php'; ?>
        ...
        <div class="container">
            <div class="bank-header-content">
                <div class="bank-logo-large">
                    <img src="https://images.goodreturns.in/webp/common_dynamic/images/social_share/fastag_18.jpg" alt="IDFC FIRST Bank">
                </div>
                <div class="bank-info">
                    <h1>IDFC FIRST FASTag</h1>
                    <p>Choose your vehicle category for IDFC FIRST Bank FASTag. Modern banking with customer-first approach.</p>
    ...
    <!-- Bank Benefits -->
    <section class="benefits-section idfc-theme">
        <div class="container">
            <h2>Why Choose IDFC FIRST FASTag?</h2>

<body data-page="products" data-bank="IDFC" class="bg-light">
...
<main class="container py-4">
    ...
    <div class="card border-0 shadow-sm overflow-hidden">
      <div class="row g-0 align-items-center">
        ...
        <div class="col-md-8 p-4">
          <h1 class="fw-bold mb-2" style="color:#9b1fe8">
            IDFC FIRST FASTag
          </h1>

          <p class="text-muted mb-3">
            Choose your vehicle category for IDFC FIRST Bank FASTag.
            Modern banking with a customer-first approach.
          </p>

          <div class="d-flex flex-wrap gap-3 small">
            <div class="d-flex align-items-center gap-2">
              <i class="fas fa-clock" style="color:#9b1fe8"></i>
              <span>24-hour activation</span>
            </div>
            <div class="d-flex align-items-center gap-2">
              <i class="fas fa-shield-alt" style="color:#9b1fe8"></i>
              <span>Advanced security</span>
            </div>
            <div class="d-flex align-items-center gap-2">
              <i class="fas fa-mobile-alt" style="color:#9b1fe8"></i>
  ...
  <div id="noResults" class="text-center py-5 d-none">
    ...
    <p class="text-muted">No IDFC FASTag products available.</p>
  </div>

  <!-- BANK BENEFITS -->
  <section class="mt-5">
    <h3 class="fw-bold mb-4">Why Choose IDFC FIRST FASTag?</h3>

    <div class="row g-4">
      <div class="col-md-3 col-6">
        <div class="card h-100 text-center shadow-sm border-0">
          <div class="card-body">
            <i class="fas fa-users fa-2x mb-2" style="color:#9b1fe8"></i>
      ...
      <div class="col-md-3 col-6">
        <div class="card h-100 text-center shadow-sm border-0">
          <div class="card-body">
            <i class="fas fa-mobile-alt fa-2x mb-2" style="color:#9b1fe8"></i>
      ...
      <div class="col-md-3 col-6">
        <div class="card h-100 text-center shadow-sm border-0">
          <div class="card-body">
            <i class="fas fa-cog fa-2x mb-2" style="color:#9b1fe8"></i>
      ...
      <div class="col-md-3 col-6">
        <div class="card h-100 text-center shadow-sm border-0">
          <div class="card-body">
            <i class="fas fa-headset fa-2x mb-2" style="color:#9b1fe8"></i>
